...
export const margin = {top: 10, right: 20, bottom: 170, left: 70};
export const margin2 = {top: 285, right: 20, bottom: 70, left: 70};
export const width = 960 - margin.left - margin.right;
export const height = 400 - margin.top - margin.bottom;
export const height2 = 400 - margin2.top - margin2.bottom;
